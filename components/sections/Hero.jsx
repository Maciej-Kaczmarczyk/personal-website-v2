...
const Hero = () => {
  return (
    <div
      id="hero"
      className="relative z-30 mb-64 flex h-fit w-[100vw] justify-center pt-16 sm:pt-32 lg:pt-72"
    >
      <div className="relative flex h-full flex-col items-center gap-7 text-center">
        <h2 className="relative  z-20 bg-gradient-to-b from-[#E8EBF1] to-[#B7B7B7] bg-clip-text px-4 py-2 text-5xl font-extrabold text-transparent drop-shadow-sm lg:text-8xl">
        ...
        <h1 className="max-w-3xl px-4 font-light text-white opacity-80 xl:text-xl xl:leading-relaxed">
        ...
        <div className="mt-6 flex w-[100vw]  justify-center gap-8 px-4 lg:w-fit">
          <ButtonFill className="w-1/2 lg:w-[200px]">Contact</ButtonFill>
          <ButtonOutline className="w-1/2 lg:w-[200px]">
            Portfolio
          </ButtonOutline>
        </div>
        <CurvedLine className="absolute -top-[300px] z-10 lg:-top-[230px] " />
        <CurvedLine2 className="absolute -top-[160px] z-10 lg:-top-[70px]" />
      </div>
