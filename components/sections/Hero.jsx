...
const Hero = () => {
  return (
    <div id="hero" className="xL:mb-64 relative z-30 mb-32 flex h-fit w-[100vw] justify-center pt-16 sm:pt-32 xl:mb-64 xl:pt-72">
      <div className="relative z-30 flex h-full flex-col items-center gap-7 text-center">
        <h2 className="relative z-20 bg-gradient-to-b from-[#E8EBF1] to-[#B7B7B7] bg-clip-text px-4 py-2 text-5xl font-extrabold tracking-tight text-transparent drop-shadow-sm lg:text-8xl">
          ...
          <span className="bg-gradient-to-b from-[#E8EBF1] to-[#B7B7B7] bg-clip-text text-transparent relative z-30">creative person</span> <br /> for your project?
        </h2>
        <h1 className="z-20 max-w-3xl px-4 text-lg font-light text-white opacity-80 xl:text-xl xl:leading-relaxed">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quam cum praesentium ad harum ullam placeat</h1>
