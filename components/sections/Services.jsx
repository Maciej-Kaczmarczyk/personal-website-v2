...
const Skills = () => {
  return (
    <div
      id="services"
      className="relative z-40 flex h-fit w-full flex-col justify-center overflow-x-clip bg-gray-dark md:my-0"
    >
      <h2 className="xL:mb-20 relative z-20 bg-gradient-to-b from-[#E8EBF1] to-[#B7B7B7] bg-clip-text py-2 text-center text-5xl font-extrabold text-transparent drop-shadow-sm lg:py-32 lg:text-6xl">
      ...
      <div className="flex w-full flex-col">
        <div className="flex w-full flex-col-reverse lg:flex-row">
          <div className="flex items-center justify-center lg:w-5/12 lg:justify-end">
            <div className="flex flex-col gap-6 text-center lg:max-w-[500px] lg:gap-10 xl:text-left">
              ...
              <div className="flex flex-wrap justify-around gap-5 xl:justify-start">
          ...
          <div className="py-10 lg:w-5/12 lg:py-20 lg:pr-20">
